                        ...
                        <div class="card-body p-5 text-center">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4 form-control-md">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="remember" style="font-size: 0.90rem;">Remember me</label>
                                </div>
                                {{-- Forgot Password --}}
                                <a href="#!" style="text-decoration: none; font-size: 0.90rem;">Forgot password?</a>
                            </div>
